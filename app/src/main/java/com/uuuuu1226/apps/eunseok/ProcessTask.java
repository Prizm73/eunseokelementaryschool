/*
소스 개발자 : Mir(whdghks913)
오픈소스 링크 : https://bitbucket.org/whdghks913/wondanghighschool
 */
...
public abstract class ProcessTask extends AsyncTask<Integer, Integer, Long> {
    ...
    final String schulCode = "B100001434"; // 학교 고유 코드
    final String schulCrseScCode = "2"; // 학교 종류 코드 1
    final String schulKndScCode = "02"; // 학교 종류 코드 2
